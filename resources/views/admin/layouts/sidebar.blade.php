            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                <li class="has-sub active expand">
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                        ...
                        <span class="nav-text">Admin Home</span> <b class="caret"></b>
                    </a>
                    <ul class="collapse show" id="dashboard" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                            ...
                            <li class="active">
                                <a class="sidenav-item-link" href="{{ route('admin.allSlider') }}">
                            ...
                            <li>
                                <a class="sidenav-item-link" href="{{ route('admin.allAbout') }}">
                                    <span class="nav-text">Home About</span>

                                    <span class="badge badge-success">About</span>
                            ...
                            <li>
                                <a class="sidenav-item-link" href="{{ route('admin.MultiImage') }}">
                            ...
                            <li>
                                <a class="sidenav-item-link" href="{{ route('admin.allBrand') }}">
